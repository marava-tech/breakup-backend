...
public class FeedbackService {
    ...
    // Admin method to submit admin response and update status to IN_REVIEW if
    // currently PENDING
    ...
    public PagedResponse<FeedbackResponse> getFeedbacksWithFilters(
        ...
        if (feedbackId != null && !feedbackId.trim().isEmpty()) {
            ...
            feedbackPage = feedbackRepository.findByUserIdAndStoryIdAndTypeAndStatus(userId, storyId, typeFilter,
            ...
            feedbackPage = feedbackRepository.findByStoryIdAndTypeAndStatus(storyId, typeFilter, statusFilter,
                    pageable);
