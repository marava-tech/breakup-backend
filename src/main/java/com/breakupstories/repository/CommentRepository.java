...
public interface CommentRepository extends MongoRepository<Comment, String> {
    ...
    /**
     * Find comments created after the specified time with null category,
     * explanation, and confidence
     * 
     * @param fromTime The start time
     * @return List of comments created after the specified time with null abuse
     *         detection fields
     */
    ...
    List<Comment> findByIsAbusiveFalseAndExplanationIsNullAndCategoryIsNullAndCreatedAtAfter(LocalDateTime createdAt);
    ...
    Page<Comment> findByStoryIdAndUserIdAndIsAbusive(String storyId, String userId, Boolean isAbusive,
            Pageable pageable);
    ...
    Page<Comment> findByStoryIdAndIsAbusiveAndCategory(String storyId, Boolean isAbusive, String category,
            Pageable pageable);

    Page<Comment> findByStoryIdAndIsAbusiveAndActive(String storyId, Boolean isAbusive, Boolean active,
            Pageable pageable);

    Page<Comment> findByStoryIdAndCategoryAndActive(String storyId, String category, Boolean active, Pageable pageable);

    Page<Comment> findByUserIdAndIsAbusiveAndCategory(String userId, Boolean isAbusive, String category,
            Pageable pageable);

    Page<Comment> findByUserIdAndIsAbusiveAndActive(String userId, Boolean isAbusive, Boolean active,
            Pageable pageable);

    Page<Comment> findByUserIdAndCategoryAndActive(String userId, String category, Boolean active, Pageable pageable);

    Page<Comment> findByIsAbusiveAndCategoryAndActive(Boolean isAbusive, String category, Boolean active,
            Pageable pageable);

    // Four-way combinations
    Page<Comment> findByStoryIdAndUserIdAndIsAbusiveAndCategory(String storyId, String userId, Boolean isAbusive,
            String category, Pageable pageable);

    Page<Comment> findByStoryIdAndUserIdAndIsAbusiveAndActive(String storyId, String userId, Boolean isAbusive,
            Boolean active, Pageable pageable);

    Page<Comment> findByStoryIdAndUserIdAndCategoryAndActive(String storyId, String userId, String category,
            Boolean active, Pageable pageable);

    Page<Comment> findByStoryIdAndIsAbusiveAndCategoryAndActive(String storyId, Boolean isAbusive, String category,
            Boolean active, Pageable pageable);

    Page<Comment> findByUserIdAndIsAbusiveAndCategoryAndActive(String userId, Boolean isAbusive, String category,
            Boolean active, Pageable pageable);

    // All filters
    Page<Comment> findByStoryIdAndUserIdAndIsAbusiveAndCategoryAndActive(String storyId, String userId,
            Boolean isAbusive, String category, Boolean active, Pageable pageable);
}